...
class TalesOfTribute(gym.Env):
    ...
    def step(self, action):
        ...
        if decoded_message[0] == "Gamestate":
            ...
            reward = decoded_message[1]     # at the end of the game, we give a reward of 1 for winning and 0 for losing. 
    ...
    def reset(self, seed=None, options=None):
        ...
        self.process = subprocess.Popen(['C:\\Users\\lashm\\OneDrive\\Desktop\\SoT_RL_WORKING\\ScriptsOfTribute-Core-master\\GameRunner\\bin\\Release\\net7.0\\GameRunner',
                          "cmd:python ../../../../Bots/ExternalLanguageBotsUtils/Python/OLD_rl-bridge.py",
                          "MaxPrestigeBot",
                          "-n", "1", 
                          "-t", "1"], 
...
if __name__ == "__main__":
    ...
    model = PPO.load("C:\\Users\\lashm\\OneDrive\\Desktop\\SoT_RL_WORKING\\Models\\PPO_V6_rerun\\9.2.2024\\1060_training_iterations.zip", env)
