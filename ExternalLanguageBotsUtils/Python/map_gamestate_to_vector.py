...
EFFECT_FOLLOWUP_KEY = {
    'ENACT_CHOSEN_EFFECT' : 0,
    'REPLACE_CARDS_IN_TAVERN' : 1,
    'DESTROY_CARDS' : 2,
    'DISCARD_CARDS' : 3,
    'REFRESH_CARDS' : 4,
    'TOSS_CARDS' : 5,
...
def map_gamestate_to_vector(gamestate):
    ...
    '''
    ## Effect Follow-up
    effect_followup_vec = np.zeros(12)
    if type(gamestate['PendingChoice']) == dict:
        effect_followup_vec[EFFECT_FOLLOWUP_KEY[gamestate['PendingChoice']['ChoiceFollowUp']]] = 1
        #print(gamestate['PendingChoice'])
        #print(effect_followup_vec)
    
    vec[14079:] = effect_followup_vec
    '''
    return vec
