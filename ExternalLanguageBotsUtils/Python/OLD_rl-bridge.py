...
from map_gamestate_to_vector_OLD import map_gamestate_to_vector
from map_action_to_vector_OLD import map_action_to_vector
from card_rating_function_OLD import rate_card, convert_gamestate_cardname_to_cardsjson_cardname
...
def get_game_state():
    ...
    if FINISHED_TOKEN in data:
        ...
        file_path = 'C:\\Users\\lashm\\OneDrive\\Desktop\\SoT_RL_WORKING\Logs\\V6-rerun-winrate'
...
if __name__ == '__main__':
    ...
    while True:
        ...
        normalized_reward = lambda prestige, k=1/5, P_target=40: (math.exp(k * prestige) - 1) / (math.exp(k * P_target) - 1)
