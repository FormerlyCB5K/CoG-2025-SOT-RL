...
def get_game_state():
    ...
    if FINISHED_TOKEN in data:
        ...
        #file_path = 'C:\\Users\\lashm\\OneDrive\\Desktop\\SoT_RL_WORKING\Logs\\V14_vs_MCTS'
        ...
        if actions[i].startswith("END_TURN"):
            ...
            if cardname.upper().strip() == cardname.strip():
                ...
                for card in cardname.split(" "):
                    card_values.append(nn_rate_cards.nn_rate_card(card, weight_vector))
            ...
            weighted_action_space[i] = nn_rate_cards.nn_rate_card(cardname, weight_vector)
